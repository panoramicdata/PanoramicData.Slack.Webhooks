...
public class SlackMessage
{
	...
	/// <summary>
	/// Enable link names for channel and usernames
	/// </summary>
	...
	/// </summary>
	public SlackMessage Clone(string? newChannel = null) => new()
	{
	...
	public bool ShouldSerializeIconEmoji()
		=> IconUrl == null && IconEmoji != Emoji.None;
	...
	public string AsJson()
		=> SlackClient.SerializeObject(this);
}
