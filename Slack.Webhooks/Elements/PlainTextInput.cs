...
/// 
/// A plain-text input, similar to the HTML &lt;input&gt; tag, creates a field where a user can enter free-form data. It can appear as a single-line field or a larger textarea using the <see cref="MultiLine"/>> flag.
/// 
...
/// </summary>
public class PlainTextInput() : Element(ElementType.PlainTextInput), IInputElement
{
	/// <summary>
