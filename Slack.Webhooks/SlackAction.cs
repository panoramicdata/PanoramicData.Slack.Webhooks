using PanoramicData.Slack.Webhooks.Action;
...
public class SlackAction
{
	...
	/// Our clever default behaviour is default, which means the menu's 
	...
	/// <summary>
	/// Used only with message menus. An alternate, semi-hierarchical way to 
